...
class TrainDataProvider(object):
    def __init__(self, data_dir, train_name="train2.obj", val_name="val2.obj", \
...
def save_fixed_sample(sample_size, img_size, data_dir, save_dir, \
    ...
    if not val:
        ...
        source_name = 't_fixed_source2.pkl'
        target_name = 't_fixed_target2.pkl'
        label_name = 't_fixed_label2.pkl'

    else:
        train_batch_iter = data_provider.get_val_iter(sample_size, with_charid=with_charid)
        source_name = 'fixed_source2.pkl'
        target_name = 'fixed_target2.pkl'
        label_name = 'fixed_label2.pkl'
...
if __name__ == '__main__':
    save_fixed_sample(sample_size=64, img_size=128, data_dir='/home/jsy/font/dataset', save_dir=fixed_dir, val=True)
    save_fixed_sample(sample_size=16, img_size=128, data_dir='/home/jsy/font/dataset',
